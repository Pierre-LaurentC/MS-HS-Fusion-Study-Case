...
# def vectorize(point: array | Sequence[array]) 
def vectorize(point: Union[array, Sequence[array]]) -> array:
...
def unvectorize(
    point: array, shapes: Union[Shape, Sequence[Shape]]
...
class LinOp(metaclass=TimedABCMeta):
    ...
    def dot(self, point: array) -> Union[array, Sequence[array]]:
        """Returns the forward application `A·x`."""
